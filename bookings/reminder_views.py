...
def reminder_list(request):
    ...
    try:
        ...
        logger.error(f"Error in reminder_list view: {e}")
        
        # Return a simple error page
        from django.http import HttpResponse
        return HttpResponse(f"Error loading reminders: {str(e)}")
...
def admin_reminder_manage(request):
    ...
    try:
        ...
        import logging
        logger = logging.getLogger(__name__)
        logger.error(f"Error in admin_reminder_manage view: {e}")
        
        # Return a simple error page
        from django.http import HttpResponse
        return HttpResponse(f"Error loading admin reminders: {str(e)}")
