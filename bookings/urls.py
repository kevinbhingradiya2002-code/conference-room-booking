...
urlpatterns = [
    ...
    path('debug/', debug_views.deployment_status, name='deployment_status'),
    path('fix-db/', debug_views.fix_database, name='fix_database'),
    path('add-rooms/', debug_views.add_sample_rooms, name='add_sample_rooms'),
