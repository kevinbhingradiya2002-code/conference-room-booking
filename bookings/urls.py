...
urlpatterns = [
    ...
    path('manager/rooms/<int:room_id>/edit/', views.admin_room_edit, name='admin_room_edit'),
    path('manager/rooms/<int:room_id>/delete/', views.admin_room_delete, name='admin_room_delete'),
